                        ...
                        <div className='flex space-x-6'>
                            <div>
                                ...
                                <div className='flex justify-center mt-4 space-x-4'>
                                    <button title="Upload avatar" className='px-8 py-3 rounded-full hover:bg-green-700 bg-gray-600 transition-all focus:outline-none' onClick={uploadIMG}>
                                        <svg
                                    ...
                                    <button title="Delete avatar" className='px-8 py-3 rounded-full hover:bg-red-700 bg-gray-600 transition-all focus:outline-none' onClick={delIMG}>
                            ...
                            <div>
                                <div className='flex items-center h-80'>
                                    <div className='px-2 space-y-4'>
                                        <div className='flex justify-center space-x-1'>
                                            ...
                                            <button title="Edit name" className='hover:bg-gray-800 rounded-full mt-2 h-12 px-4 transition-all focus:outline-none' onClick={handleEdit} hidden={edit ? true : false}>
                                ...
                                <div className='flex justify-center mt-4'>
                                    <button title="Sign out" className='px-8 py-3 rounded-full hover:bg-gray-800 bg-gray-600 transition-all focus:outline-none' onClick={handleLogout}>
                                        <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
